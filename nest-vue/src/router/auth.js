...
export default [
  ...
  { path: '/auth/info_1', name: 'AuthBaseInfo1', component: BaseInfo1, meta: { keepAlive: true, slideLevel: 1 } },
  { path: '/auth/info_2', name: 'AuthBaseInfo2', component: BaseInfo2, meta: { keepAlive: true, slideLevel: 1 } }
];
