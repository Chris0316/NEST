<template>
  <div class="follow">
    ...
    <div class="tabs">
      <div class="tab mtab on">房源</div>
      <div class="tab">经纪人</div>
    </div>
    <!--房源-->
    <div>
    ...
    <!--关注时间-->
    <!--followtime-->
    <nest-modal title="关注时间" :has-clear="false" :has-footer="false" @modalClose="followtimeShow = false" :status="followtimeShow">
      <nest-radio v-model="followtimeVal" :count-in-row="1" :options="followtimeOpts"></nest-radio>
    </nest-modal>

    <!--分类-->
    <!--classify-->
    <nest-modal title="分类" :has-clear="false" :has-footer="false" @modalClose="classifyShow = false" :status="classifyShow">
